            ...
            <div>
                ...
                <Grid>
                    <Cell col={4}>
                        ...
                        />
                        <p>
                            I am a motivated business professional and Software Engineer
                            that is currently pursuing a Master of Engineering Degree in
                            Systems Engineering from Cornell University. I have a talent
                            for quickly mastering technology and new programming
                            languages and stacks. I am diplomatic and tactful with
                            professionals and non-professionals at all levels. I am
                    ...
                    <Cell className='resume-right-col' col={8}>
                        ...
                        <Experience
                            ...
                            jobDescription='In charge of an enterprise Python Django application that automates existing processes. Some examples of the automated processes are: JIRA Ticket creation,
                    Slack API communication and the implementation of a pointer poker tool into the application.
                    Lead an Agile Scrum team of 15 developers as a Scrum Master and perform engineering and development changes as a
